  ...
  return (
    <RequireAuth nextPath="/familia">
      <main id="conteudo-principal" className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-8 px-4 py-8 lg:px-8">
        <div>
          <h1 className="text-3xl font-semibold tracking-tight">Família e grupos</h1>
          <p className="mt-2 text-zinc-600 dark:text-zinc-400">
            Convide pessoas e defina o que cada uma pode ver ou alterar. O grupo ativo troca no
            topo.
          </p>
        </div>
